...
class GeneratedBoardsTest extends FeatureSpec with GivenWhenThen with Matchers {
  ...
  scenario("scenario: 3x3 board 2x King, 1x Rook (first repetition of previous one but with other pieces order)") {
    Given("board (3,3)")
    val board = new Board(3, 3)
    And("2x King, 1x Rook")
  ...
  scenario("scenario: 3x3 board 2x King, 1x Rook (second repetition of previous one but with other pieces order)") {
    Given("board (3,3)")
    val board = new Board(3, 3)
    And("2x King, 1x Rook")
  ...
  scenario("scenario: 4x4 board 4x Knight, 2x Rook (first repetition of previous one but with other pieces order)") {
    Given("board (4,4)")
    val board = new Board(4, 4)
    And("4x Knight, 2x Rook")
  ...
  scenario("scenario: 4x4 board 4x Knight, 2x Rook (second repetition of previous one but with other pieces order)") {
    Given("board (4,4)")
    val board = new Board(4, 4)
    And("4x Knight, 2x Rook")
  ...
  scenario("scenario: 4x4 board 4x Knight, 2x Rook (third repetition of previous one but with other pieces order)") {
    Given("board (4,4)")
    val board = new Board(4, 4)
    And("4x Knight, 2x Rook")
